...
from .allocation_type_routes import router as allocation_type_router      
from .movement_type_routes import router as movement_type_router      

__all__ = ['product_router', 'batch_router', 'allocation_router', 'product_type_router', 'package_type_router','temperature_type_router','allocation_type_router','movement_type_router']